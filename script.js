...
const kineticCards = [
  {
    ...
    cta: '[data-asx-cta]', legal: '[data-asx-legal]',
  ...
  },
  {
    ...
    cta: '[data-grandis-cta]', legal: '[data-grandis-legal]',
  ...
  },
  {
    ...
    price: '.price-art', car: '.offer__car', cta: '.offer__copy > .cta', legal: '.offer__legal',
    extra: '.wallbox-badge',
...
const cinematicOffers = [
  ...
  .map((offer) => ({
    ...
    elements: {
      ...
      cta: offer.stage.querySelector('.offer__copy > .cta'),
    },
