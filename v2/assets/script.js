...
const tabletHero = window.matchMedia('(min-width: 720px) and (width < 1280px), (min-width: 1280px) and (width < 1367px) and (aspect-ratio < 3/2), (min-width: 1280px) and (height < 650px)');
