...
const tabletHero = window.matchMedia('(min-width: 720px) and (max-width: 1279px), (min-width: 1280px) and (max-width: 1366px) and (max-aspect-ratio: 1499/1000), (min-width: 1280px) and (max-height: 649px)');
const desktopMotion = window.matchMedia('(min-width: 1367px) and (min-height: 650px), (min-width: 1280px) and (min-aspect-ratio: 3/2) and (min-height: 650px)');
